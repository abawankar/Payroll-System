...
namespace WebPayroll.Domain.Mapping.Transaction
{
    public class SalaryRevisionMap : ClassMap<SalaryRevision>
    {
        public SalaryRevisionMap()
        {
            ...
            Map(x => x.IsPFCelling);
            References<Employee>(x => x.Employee).Column("EmpId").ForeignKey("fk_revision_empid").LazyLoad();
        }
    }
}